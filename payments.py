...
PACKAGES: dict[str, PaymentPackage] = {
    ...
    "text_business_x3": PaymentPackage("text_business_x3", "Бизнес × 3 фото", 30, 3, 5690),
    "text_business_x5": PaymentPackage("text_business_x5", "Бизнес × 5 фото", 30, 5, 8690),
    "text_business_x7": PaymentPackage("text_business_x7", "Бизнес × 7 фото", 30, 7, 11690),
    "text_pro_x0": PaymentPackage("text_pro_x0", "Про, без фото", 100, 0, 2990),
    "text_pro_x3": PaymentPackage("text_pro_x3", "Про × 3 фото", 100, 3, 17990),
    "text_pro_x5": PaymentPackage("text_pro_x5", "Про × 5 фото", 100, 5, 27990),
    "text_pro_x7": PaymentPackage("text_pro_x7", "Про × 7 фото", 100, 7, 37990),
    ...
    "addon_img_50": PaymentPackage("addon_img_50", "Докупить 50 изображений", 0, 50, 2875),
    "addon_img_150": PaymentPackage("addon_img_150", "Докупить 150 изображений", 0, 150, 8625),
