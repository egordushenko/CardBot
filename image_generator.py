...
def _build_single_image_prompt(
    ...
    *,
    ...
    return (
        ...
        "Show one coherent product scene only and follow the creative brief for framing, context, "
        "detail emphasis, and text treatment.\n\n"
        "Preserve:\n"
        ...
        "no watermark, no unreadable overlay text, no invented or unsupported labels."
    )
