...
DEFAULT_OUTPUT_MD_PATH = "data/wb_dataset_analysis.md"
DEFAULT_OUTPUT_JSON_PATH = "data/wb_dataset_analysis.json"

TITLE_SOFT_MAX = 60
DESCRIPTION_TARGET_MIN = 300
DESCRIPTION_TARGET_MAX = 1000
HASHTAG_TARGET_MIN = 0
HASHTAG_TARGET_MAX = 0
...
def build_markdown_report(report: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        "## Prompt rules",
        "",
        f"- Title: до {rules['title']['hard_max']} символов по правилам WB, целевой потолок CardBot — {rules['title']['soft_max']} символов.",
        ...
        f"- Hashtags: на WB в собранных карточках не обнаружены; поле оставляем пустым массивом.",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze Wildberries reference cards for CardBot prompts.")
