...
COMMON_FACT_GUARD = (
    ...
    "Не указывай размер товара на изображении: размер может быть во входных данных, но его не нужно писать в инфографике, "
    "заголовках, бейджах или любых других текстовых элементах изображения."
)
