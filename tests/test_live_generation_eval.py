        ...
        if case["id"] == "wb_ok":
            return CardGeneration(
                ...
                description=(
                    ...
                    "и расслабленных комплектов. Модель помогает быстро собрать удобный образ "
                    "для дома, учебы, поездки и встреч. Свободный крой помогает чувствовать комфорт "
                    "в течение дня, а черный цвет легко сочетается с джинсами, брюками и юбкой. "
                    "Футболку можно использовать как базовый слой под рубашку, куртку или худи. "
                    "Она подходит для ежедневной носки и не перегружает комплект лишними деталями."
                ),
                keywords="",
                characteristics=(
                    "Цвет: черный\n"
